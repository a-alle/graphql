    ...
    test("Update as multiple Disconnect", async () => {
        ...
        expect(formatCypher(result.cypher)).toMatchInlineSnapshot(`
            ...
            CALL {
            	...
            	WITH collect(this_disconnect_actors1) as this_disconnect_actors1_list, this_disconnect_actors1_rel, this
            	UNWIND this_disconnect_actors1_list as this_disconnect_actors1
